...
import { Calendar, MessageSquare, ChevronLeft, ChevronRight, Clock, CheckSquare, Video, Globe } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0b] relative">
      ...
      <section className="px-6 pt-32 pb-8 max-w-4xl mx-auto text-center relative z-10">
        <p className="text-[11px] uppercase tracking-[0.35em] text-zinc-500 mb-5">Contact</p>
        <h1 className="text-4xl md:text-5xl lg:text-[56px] font-medium leading-tight">
          Let's Get <span className="gradient-text-pink font-serif italic">In Touch</span>
        </h1>
      </section>
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <div className="flex items-center gap-2 ml-4">
            <a
              ...
              title="Email"
            >
              <Image src="https://ext.same-assets.com/4210891837/2723767466.svg" alt="Email" width={18} height={18} />
            </a>
            <a
              ...
              title="LinkedIn"
            >
              <Image src="https://ext.same-assets.com/4210891837/1899816707.svg" alt="LinkedIn" width={18} height={18} />
            </a>
            <a
              ...
              title="GitHub"
            >
              <Image src="https://ext.same-assets.com/4210891837/3395764652.svg" alt="GitHub" width={18} height={18} />
            </a>
            <a
              ...
              title="Twitter"
            >
              <Image src="https://ext.same-assets.com/4210891837/102872261.svg" alt="Twitter" width={18} height={18} />
            </a>
          </div>
        </div>
            ...
            <div className="bg-[#111113] border border-zinc-800 rounded-2xl overflow-hidden">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-6 border-b md:border-b-0 md:border-r border-zinc-800 md:w-[280px]">
                  ...
                  <h3 className="text-white text-xl font-semibold mb-4">30 Min Meeting</h3>
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <h4 className="text-white font-medium">
                      {monthNames[currentMonth]} <span className="text-zinc-500">{currentYear}</span>
                    </h4>
                  ...
                  {selectedDate && (
                    <div className="mt-6 p-4 bg-zinc-800/50 rounded-xl">
                      <p className="text-zinc-400 text-sm mb-2">
                        Selected: {monthNames[currentMonth]} {selectedDate}, {currentYear}
                      </p>
