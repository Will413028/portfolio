  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute w-px h-px bg-white rounded-full opacity-40" style={{ left: '10%', top: '15%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-30" style={{ left: '25%', top: '8%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-50" style={{ left: '40%', top: '22%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-40" style={{ left: '55%', top: '5%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-30" style={{ left: '70%', top: '18%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-50" style={{ left: '85%', top: '12%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-40" style={{ left: '15%', top: '35%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-30" style={{ left: '33%', top: '42%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-50" style={{ left: '60%', top: '38%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-40" style={{ left: '78%', top: '45%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-30" style={{ left: '92%', top: '28%' }} />
        <div className="absolute w-px h-px bg-white rounded-full opacity-50" style={{ left: '5%', top: '55%' }} />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 mb-8 px-1 py-1 bg-zinc-900/60 border border-zinc-800 rounded-full text-sm backdrop-blur-sm hover:border-zinc-700 transition-colors cursor-pointer group">
          ...
          <span className="text-zinc-300 pr-2">Nextnode is launching soon!</span>
          <ArrowRight size={14} className="text-zinc-400 mr-2 group-hover:translate-x-0.5 transition-transform" />
        </div>
