  ...
  return (
    <section className="px-6 py-24 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* Left: Text content */}
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-500 mb-4">Know About Me</p>
        ...
        <div className="flex items-center justify-center">
          <div className="relative">
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-3xl bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700 flex items-center justify-center shadow-2xl overflow-hidden">
              {/* SVG Logo */}
              <svg width="180" height="180" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-56 md:h-56">
                <path d="M100 30L170 170H30L100 30Z" stroke="white" strokeWidth="3" fill="none"/>
                <path d="M100 70L140 170H60L100 70Z" stroke="white" strokeWidth="2" fill="none"/>
