    ...
    <footer className="px-6 py-16 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* General */}
          <div>
            <h4 className="text-xs uppercase tracking-widest text-zinc-500 mb-4">General</h4>
          ...
          {/* Specifics */}
          <div>
            <h4 className="text-xs uppercase tracking-widest text-zinc-500 mb-4">Specifics</h4>
            <ul className="space-y-2">
          ...
          {/* More */}
          <div>
            <h4 className="text-xs uppercase tracking-widest text-zinc-500 mb-4">More</h4>
            <ul className="space-y-2">
              {moreLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-sm text-zinc-400 hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-500">
            © 2026 <span className="text-zinc-300">Aayush Bharti</span>. All rights reserved
          </p>
